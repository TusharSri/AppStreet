    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                ...
                new DownloadImageTask(movieVH.imageView).execute(imageUrl.getUrl());
...
//                Do nothing
    ...
    */
    ...
    public void add(ImageUrl mc) {
        imageUrls.add(mc);
        notifyItemInserted(imageUrls.size() - 1);
    }

    public void addAll(List<ImageUrl> mcList) {
        for (ImageUrl mc : mcList) {
            add(mc);
        }
    }

    public void remove(ImageUrl city) {
    ...
    public void removeLoadingFooter() {
        ...
        ImageUrl item = getItem(position);
